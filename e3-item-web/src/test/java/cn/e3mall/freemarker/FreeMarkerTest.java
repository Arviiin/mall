...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		//3、设置模板文件保存的目录
		configuration.setDirectoryForTemplateLoading(new File("G:/Code/JavaEEProject/e3-item-web/src/main/webapp/WEB-INF/ftl"));
...
//		Writer out = new FileWriter(new File("D:/temp/JavaEE32/freemarker/hello.txt"));//或者\\ 或者/
		Writer out = new FileWriter(new File("D:/temp/JavaEE32/freemarker/student.html"));//或者\\ 或者/
		//8、生成静态页面
